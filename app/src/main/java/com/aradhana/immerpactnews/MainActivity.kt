...
*/
        ...
        heading.setBackgroundColor(Color.parseColor(sharedPreferences.getString(HEAD_BG_PREF,"#ffffff")))
        ...
        content.setBackgroundColor(Color.parseColor(sharedPreferences.getString(CONTENT_BG_PREF,"#000000")))
        ...
        marque.setBackgroundColor(Color.parseColor(sharedPreferences.getString(MARQUE_BG_PREF,"#ffffff")))
        ...
        logoText.setBackgroundColor(Color.parseColor(sharedPreferences.getString(LOGO_BG,"#000000")))
        ...
        additional_info.setBackgroundColor(Color.parseColor(sharedPreferences.getString(ADD_INFO_BG,"#000000")))
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            var  encodePref:String = android.util.Base64.encodeToString(byteArrayPref, android.util.Base64.DEFAULT);
            var encodedImage: String? = sharedPreferences.getString("encodedImage", encodePref)
            var decodeByteImg: ByteArray = android.util.Base64.decode(encodedImage,
...
/*
    ...
    private fun initRecorder() {
        try {
            val camcorderProfile: CamcorderProfile = CamcorderProfile.get(CamcorderProfile.QUALITY_HIGH)
            ...
            vidioUri = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() + StringBuilder("/")
                .append("News Maker")
